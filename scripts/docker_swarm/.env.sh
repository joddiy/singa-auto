...
export SINGA_AUTO_HOST=127.0.0.1
export ADMIN_EXT_PORT=9532
export WEB_ADMIN_EXT_PORT=9533
export POSTGRES_EXT_PORT=9534
export REDIS_EXT_PORT=9536
export ZOOKEEPER_EXT_PORT=9537
export KAFKA_EXT_PORT=9538
export HOST_WORKDIR_PATH=$PWD
export APP_MODE=PROD # DEV or PROD
